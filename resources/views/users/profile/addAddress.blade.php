                ...
                @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="phone" type="number" placeholder="919876543210" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>House Name</label>
                            <input class="form-control" name="house_name" type="text" placeholder="House Name" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Street</label>
                            <input class="form-control" name="street" type="text" placeholder="Street" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Country</label>
                        ...
                        <div class="col-md-6 form-group">
                            <label>City</label>
                            <input class="form-control" name="city" type="text" placeholder="Kozhikode" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>State</label>
                            <input class="form-control" name="state" type="text" placeholder="Kerala" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>ZIP Code</label>
                            <input class="form-control" name="pincode" type="number" placeholder="123-456" required>
                        </div>
                        <div class="d-grid">
